...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{entry: '', httpState: $author$project$Main$Loading, items: _List_Nil, visibility: $author$project$Main$All},
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Main$FetchedItems = function (a) {
	return {$: 'FetchedItems', a: a};
};
var $author$project$Main$NoOp = {$: 'NoOp'};
var $author$project$Main$SavedItems = function (a) {
	return {$: 'SavedItems', a: a};
};
...
var $author$project$Item$Normal = {$: 'Normal'};
var $author$project$Item$init = F2(
	function (description, uuid) {
		return {completed: false, description: description, edit: $elm$core$Maybe$Nothing, uuid: uuid, visibility: $author$project$Item$Normal};
	});
var $author$project$Item$Model = F5(
	function (description, uuid, completed, edit, visibility) {
		return {completed: completed, description: description, edit: edit, uuid: uuid, visibility: visibility};
	});
...
var $author$project$Main$itemsDecoder = $elm$json$Json$Decode$list(
	A6(
		...
		$elm$json$Json$Decode$succeed($author$project$Item$Normal)));
...
var $author$project$Main$itemsEncoder = function (items) {
	return A2(
		$elm$json$Json$Encode$list,
		function (item) {
			return $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						...
						_Utils_Tuple2(
						'uuid',
						$TSFoster$elm_uuid$UUID$toValue(item.uuid)),
						_Utils_Tuple2(
						'completed',
						$elm$json$Json$Encode$bool(item.completed))
					]));
		},
		items);
};
...
var $author$project$Item$Editing = {$: 'Editing'};
var $author$project$Item$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Toggle':
				return $elm$core$Maybe$Just(
			...
			case 'EditCommit':
				return $elm$core$Maybe$Just(
					_Utils_update(
						model,
						{
							description: A2($elm$core$Maybe$withDefault, model.description, model.edit),
							edit: $elm$core$Maybe$Nothing,
							visibility: $author$project$Item$Normal
						}));
			case 'EditCancel':
				return $elm$core$Maybe$Just(
					_Utils_update(
						model,
						{edit: $elm$core$Maybe$Nothing, visibility: $author$project$Item$Normal}));
			case 'Focus':
				return $elm$core$Maybe$Just(
					_Utils_update(
						model,
						{visibility: $author$project$Item$Editing}));
			default:
				return $elm$core$Maybe$Nothing;
		}
	});
		...
		switch (msg.$) {
			case 'GenerateUuid':
				return _Utils_Tuple2(
					...
					A2(
						...
						A2($elm$random$Random$int, 100, 999)));
			case 'EntryChange':
				var entry = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'AddItem':
				...
				var uuid = A2(
					...
					$elm$random$Random$initialSeed(random)).a;
				var newItem = A2($author$project$Item$init, model.entry, uuid);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							entry: '',
							items: A2($elm$core$List$cons, newItem, model.items)
						}),
					$elm$core$Platform$Cmd$none);
				...
				var updatedModel = _Utils_update(
					model,
					{
						items: A2(
							$elm$core$List$map,
							function (item) {
								return _Utils_eq(item.uuid, uuid) ? A2(
									$elm$core$Maybe$withDefault,
									item,
									A2($author$project$Item$update, itemMsg, item)) : item;
							},
							model.items)
					});
				switch (itemMsg.$) {
					...
					case 'Focus':
						...
						return _Utils_Tuple2(
							...
							A2(
								...
								$elm$browser$Browser$Dom$focus(input_id)));
					default:
			...
			case 'FetchedItems':
				...
				if (res.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{httpState: $author$project$Main$Success, items: items}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{httpState: $author$project$Main$Failure}),
						$elm$core$Platform$Cmd$none);
				}
			case 'Save':
				return _Utils_Tuple2(
			...
			case 'SavedItems':
				...
				if (res.$ === 'Ok') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{httpState: $author$project$Main$Success}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
...
var $author$project$Main$EntryChange = function (a) {
	return {$: 'EntryChange', a: a};
};
var $author$project$Main$Fetch = {$: 'Fetch'};
var $author$project$Main$GenerateUuid = {$: 'GenerateUuid'};
...
var $author$project$Main$itemInput = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('itemInput')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Main$ChangeVisibility($author$project$Main$All))
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick(
						$author$project$Main$ChangeVisibility($author$project$Main$Active))
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick(
						$author$project$Main$ChangeVisibility($author$project$Main$Completed))
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onSubmit($author$project$Main$GenerateUuid)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$placeholder('add item'),
								$elm$html$Html$Attributes$value(model.entry),
								$elm$html$Html$Events$onInput($author$project$Main$EntryChange),
...
var $author$project$Item$Delete = {$: 'Delete'};
var $author$project$Item$EditCancel = {$: 'EditCancel'};
var $author$project$Item$EditChange = function (a) {
	return {$: 'EditChange', a: a};
};
var $author$project$Item$EditCommit = {$: 'EditCommit'};
var $author$project$Item$Focus = function (a) {
	return {$: 'Focus', a: a};
};
var $author$project$Item$NoOp = {$: 'NoOp'};
var $author$project$Item$Toggle = {$: 'Toggle'};
...
var $author$project$Item$onFinish = F3(
	function (enter, esc, noOp) {
...
var $author$project$Item$view = function (model) {
	var input_id = 'input_' + $TSFoster$elm_uuid$UUID$toString(model.uuid);
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onClick($author$project$Item$Toggle)
									]),
								_List_Nil),
								A2(
								$elm$html$Html$label,
								_List_fromArray(
									[
										...
										$author$project$Item$Focus(input_id))
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Item$Delete)
									]),
								$1602$elm_feather$FeatherIcons$x)
							]));
				} else {
					return A2(
						$elm$html$Html$li,
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onInput($author$project$Item$EditChange),
										A3($author$project$Item$onFinish, $author$project$Item$EditCommit, $author$project$Item$EditCancel, $author$project$Item$NoOp),
										$elm$html$Html$Attributes$value(
										A2($elm$core$Maybe$withDefault, model.description, model.edit))
									]),
								_List_Nil)
							]));
				}
...
var $author$project$Main$itemList = F2(
	function (items, visibility) {
		...
		return A2(
			...
			A2(
				$elm$core$List$map,
				function (item) {
					var v = $author$project$Item$view(item);
					var i = item.uuid;
					return A2(
						$elm$html$Html$map,
						function (msg) {
							return A2($author$project$Main$UpdateItem, msg, i);
						},
						v);
				},
				visibleItems));
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$itemInput(model),
				A2($author$project$Main$itemList, model.items, model.visibility)
			]));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{init: $author$project$Main$init, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Item.Model":{"args":[],"type":"{ description : String.String, uuid : UUID.UUID, completed : Basics.Bool, edit : Maybe.Maybe String.String, visibility : Item.Visibility }"}},"unions":{"Main.Msg":{"args":[],"tags":{"GenerateUuid":[],"AddItem":["Basics.Int"],"EntryChange":["String.String"],"ChangeVisibility":["Main.Visibility"],"UpdateItem":["Item.Msg","UUID.UUID"],"Fetch":[],"FetchedItems":["Result.Result Http.Error (List.List Item.Model)"],"Save":[],"SavedItems":["Result.Result Http.Error String.String"],"NoOp":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Item.Msg":{"args":[],"tags":{"Toggle":[],"Delete":[],"Focus":["String.String"],"EditChange":["String.String"],"EditCommit":[],"EditCancel":[],"NoOp":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"UUID.UUID":{"args":[],"tags":{"UUID":["Basics.Int","Basics.Int","Basics.Int","Basics.Int"]}},"Item.Visibility":{"args":[],"tags":{"Normal":[],"Editing":[]}},"Main.Visibility":{"args":[],"tags":{"All":[],"Active":[],"Completed":[]}}}}})}});
...
},{}],"../../../../../../usr/lib64/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"../../../../../../usr/lib64/node_modules/parcel-bundler/src/builtins/css-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"../../../../../../usr/lib64/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"styles.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../../../../usr/lib64/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
},{"./Main.elm":"Main.elm","./styles.css":"styles.css"}],"../../../../../../usr/lib64/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../usr/lib64/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
